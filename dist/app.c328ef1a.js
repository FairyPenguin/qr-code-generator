...
var onSubmit = function onSubmit(e) {
  ...
  if (url === "") {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        var saveUrl = qr.querySelector("img").src;
        saveButton(saveUrl);
      }, 50);
    }, 1000);
  }
};
var generateQRCode = function generateQRCode(url, size) {
...
var showUISpinner = function showUISpinner() {
  document.getElementById("spinner").style.display = "block";
};

//Hide the spinner in the UI function
var hideUISpinner = function hideUISpinner() {
  document.getElementById("spinner").style.display = "none";
};
var clearUI = function clearUI() {
  qr.innerHTML = "";
  var saveBtn = document.getElementById("save-link");
  if (saveBtn) {
    saveBtn.remove();
  }
};
...
var saveButton = function saveButton(saveURL) {
